...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n!'use strict';\n\nclass Actor {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n\n}\n\nexports.default = Actor;\n\n//# sourceURL=webpack:///./lib/modules/actor/actor.js?");

/***/ }),

/***/ "./lib/modules/eventEmitter/eventEmitter.js":
/*!**************************************************!*\
  !*** ./lib/modules/eventEmitter/eventEmitter.js ***!
  \**************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n!'use strict';\n\nclass Logger {\n  constructor() {}\n\n  log(info) {\n    console.log(info);\n  }\n\n}\n\nexports.default = Logger;\n\n//# sourceURL=webpack:///./lib/modules/logger/logger.js?");

/***/ }),

/***/ "./lib/modules/movie/movie.js":
/*!************************************!*\
  !*** ./lib/modules/movie/movie.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\n__webpack_require__(/*! core-js/modules/web.dom.iterable */ \"./node_modules/core-js/modules/web.dom.iterable.js\");\n\nvar _eventEmitter = _interopRequireDefault(__webpack_require__(/*! ../eventEmitter/eventEmitter.js */ \"./lib/modules/eventEmitter/eventEmitter.js\"));\n\nvar _social = _interopRequireDefault(__webpack_require__(/*! ../social/social.js */ \"./lib/modules/social/social.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n!'use strict';\n\nclass Movie extends _eventEmitter.default {\n  constructor(title, year, duration) {\n    super();\n    this.title = title;\n    this.year = year;\n    this.duration = duration;\n    Object.assign(this, _social.default); //Assigning the 'social' mixin to all movies\n  }\n\n  play() {\n    this.emit('Play');\n  }\n\n  pause() {\n    this.emit('Pause');\n  }\n\n  resume() {\n    this.emit('Resume');\n  }\n\n  addCast(cast) {\n    if (!this.cast) {\n      this.cast = [];\n    }\n\n    if (Array.isArray(cast)) {\n      cast.forEach(actor => {\n        this.cast.push(actor);\n      });\n    } else {\n      this.cast.push(cast);\n    }\n  }\n\n}\n\nexports.default = Movie;\n\n//# sourceURL=webpack:///./lib/modules/movie/movie.js?");

/***/ }),

/***/ "./lib/modules/social/social.js":
/*!**************************************!*\
  !*** ./lib/modules/social/social.js ***!
  \**************************************/
/*! no static exports found */
